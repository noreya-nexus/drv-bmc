...
impl BmcModule {
    ...
    pub fn handle_function( desc : Descriptor, ctl_pair : ChannelPair<ManagedThreadState>, dev_pair : ChannelPair<PMsg>) {
        ...
        while !stopped {
            ...
            match BmcModule::transfer(&mut dev_handle, CoreBuilder::new().control().set_sclk_speed(desc.max_sclk_speed()).unwrap()) {
                Ok(response) => {
            ...
            while !stopped {
                ...
                if  result.is_ok(){
                    ...
                    for i in 0..3 {
                        ...
                        let ret =  BmcModule::transfer(&mut dev_handle, msg.get_msg().unwrap());
                ...
                match BmcModule::transfer(&mut dev_handle, FrameBuilder::new().core().control().mode_run().unwrap()) {
